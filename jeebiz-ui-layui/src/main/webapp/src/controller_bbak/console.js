  ...
  layui.use('table', function(){
    ...
    table.render({
      ...
      ,cols: [[
        ...
        ,{field: 'keywords', title: '级别', minWidth: 300, templet: '<div><a href="https://www.baidu.com/s?wd={{ d.keywords }}" target="_blank" class="layui-table-link">{{ d.keywords }}</div>'}
        ,{field: 'frequency', title: '试卷', minWidth: 120, sort: true}
    ...
    table.render({
      ...
      ,cols: [[
        ...
        ,{field: 'title', title: '题干', minWidth: 300, templet: '<div><a href="{{ d.href }}" target="_blank" class="layui-table-link">{{ d.title }}</div>'}
        ,{field: 'username', title: '问题'}
        ,{field: 'crt', title: '错误率', sort: true}
      ]]
      ,skin: 'line'
    });
  });
