	...
	<view :class="setCollapseCellClass" :hover-class="disabled === true || disabled === 'true' ? '' : 'uni-collapse-cell--hover'">
		<view class="uni-collapse-cell__title" @click="onClick">
			...
			<view class="uni-collapse-cell__title-inner ">
				<view class="uni-collapse-cell__title-text">{{title}}<a style='position:absolute;right: 40px;color:#C7C7CC ;display: inline-block;'>{{numbers}}</a></view>
...
<script>
	import uniIcon from '../uni-icon/uni-icon'
